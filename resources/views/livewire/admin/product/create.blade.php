                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <div class="mt-1 flex items-center">
                                @if ($image)
                                    <img src="{{ $image->temporaryUrl() }}" alt="Preview" class="h-12 w-12 rounded-full object-cover mr-4">
                                @endif
                                <input type="file" wire:model="image" class="focus:ring-red-500 focus:border-red-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
